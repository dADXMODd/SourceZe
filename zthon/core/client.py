            ...
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        link = "[𐇮 DAD MODY 𐇮](https://t.me/UP_UO)"
                        text = (
                            "**✘ تقـريـر اشعـار زد إي ZE ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار زد إي ZE ✘**\n\n "
                        link = "[𐇮 DAD MODYـه 𐇮](https://t.me/UP_UO)"
